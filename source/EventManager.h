...
class DebugView;
class BLOCO_UTILITY_API ILuaable
{
public:
...
class BLOCO_UTILITY_API IEventData;
typedef shared_ptr<IEventData> BLOCO_UTILITY_API IEventDataPtr;

class BLOCO_UTILITY_API IEventData : public ILuaable
{
public:
...
class BLOCO_UTILITY_API BaseEventData : public IEventData
{
public:
...
template < typename T >
struct BLOCO_UTILITY_API EvtData : public BaseEventData
{
private:
...
typedef EvtData<int> BLOCO_UTILITY_API EvtData_Int;

// struct EvtData_ScriptEvtData					- Chapter 11, page 328
//This type of event data is created by script-defined events.
struct BLOCO_UTILITY_API EvtData_ScriptEvtData : public BaseEventData
{
public:
...
// imposed or assumed.
class BLOCO_UTILITY_API IEventListener
{
public:
...
typedef shared_ptr<IEventListener> BLOCO_UTILITY_API   EventListenerPtr;
//typedef concurrent_queue<IEventDataPtr> ThreadSafeEventQueue;

class BLOCO_UTILITY_API IEventManager
{
public:
...
private:
	...
	friend bool BLOCO_UTILITY_API safeAddListener( EventListenerPtr const & inHandler,
		EventType const & inType );

	friend bool BLOCO_UTILITY_API safeDelListener( EventListenerPtr const & inHandler,
		EventType const & inType );

	friend bool BLOCO_UTILITY_API safeTriggerEvent( IEventData const & inEvent );

	friend bool BLOCO_UTILITY_API safeQueEvent( IEventDataPtr const & inEvent );
	friend bool BLOCO_UTILITY_API threadSafeQueEvent( IEventDataPtr const & inEvent );

	friend bool BLOCO_UTILITY_API safeAbortEvent( EventType const & inType,
		bool allOfType = false );

	friend bool BLOCO_UTILITY_API safeTickEventManager( unsigned long maxMillis =
		IEventManager::kINFINITE );

	friend bool BLOCO_UTILITY_API safeValidateEventType( EventType const & inType );

	friend void BLOCO_UTILITY_API safeSetDebugView(DebugView* pDebugView);
	friend void BLOCO_UTILITY_API safeRemoveDebugView();
};


extern IEventManager BLOCO_UTILITY_API* g_pEventMgr;
...
bool BLOCO_UTILITY_API  threadSafeQueEvent( IEventDataPtr const & inEvent );
bool BLOCO_UTILITY_API  safeAbortEvent( EventType const & inType, bool allOfType /* = false */ );
bool BLOCO_UTILITY_API  safeTickEventManager( unsigned long maxMillis /* = IEventManager::kINFINITE */ );
