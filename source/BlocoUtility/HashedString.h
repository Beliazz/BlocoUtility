...
typedef class CILHashedString BLOCO_UTILITY_API EventType;

extern void BLOCO_UTILITY_API * hash_name(char const * pIdentStr);

class BLOCO_UTILITY_API CILHashedString
{
private:
